...
\item Flatten the faces in a mesh where they are not flat (e.\+g., generic hexahedral meshes) \mbox{\hyperlink{FlattenFaces_8cpp}{Flatten\+Faces}},
\item Create a .vtu file from an RF mesh file \mbox{\hyperlink{MeshToVTU_8cpp}{Mesh\+To\+VTU}},
\item Transform a .msh file (created by Gmsh, version 4.\+11) into an RF mesh file \mbox{\hyperlink{MSHToRF_8cpp}{MSHTo\+RF}}.
\end{DoxyItemize}
...
\item \mbox{\hyperlink{group__DDR__stokes}{DDR\+\_\+stokes}}\+: Discrete De Rham (DDR) scheme, and serendipity version, for the Stokes problem in curl-\/curl form.
...
\item \mbox{\hyperlink{group__DDR__yangmills}{DDR\+\_\+yangmills}}\+: DDR scheme for the Yang-\/\+Mills equations (based on \mbox{\hyperlink{group__LADDRCore}{LADDR}}, the extension of DDR to Lie algebra valued fields).
