...
namespace HArDCore3D
{
  ...
  public:
    ...
    /// Compute the matrix of the L2 product, applying leftOp and rightOp to the variables; this is the main function called by computeL2Product and computeL2ProductCurl
