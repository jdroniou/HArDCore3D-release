...
DDRSpace::DDRSpace(
  ...
  : DOFSpace(mesh, n_local_vertex_dofs, n_local_edge_dofs, n_local_face_dofs, n_local_cell_dofs)
{
  // Do nothing
}
...
Eigen::VectorXd DDRSpace::restrictFace(size_t iF, const Eigen::VectorXd & vh) const
{
...
Eigen::MatrixXd DDRSpace::extendOperator(const Cell & T, const Face & F, const Eigen::MatrixXd & opF) const
{
...
std::vector<size_t> DDRSpace::globalDOFIndices(const Face & F) const
{
