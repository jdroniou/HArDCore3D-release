...
Eigen::MatrixXd GramMatrix(
                  const Cell& T,                          ///< Cell to which the basis corresponds
                  const TensorizedVectorFamily<BasisType1, dimspace> & basis1,              ///< Tensorized family (rows of the Gram matrix)
                  const DivergenceBasis<MatrixFamily<BasisType2, dimspace>> & basis2,   ///< Divergence of MatrixFamily (columns of the Gram matrix)
                  MonomialCellIntegralsType mono_int_map = {} ///< Optional list of integrals of monomials up to the sum of max degree of basis1 and basis2
                  )
  {
