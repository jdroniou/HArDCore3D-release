// Implementation of the HHO scheme in 3D for the diffusion equation, with K piecewise constant, \beta \in H^1(\Omega)^d and \mu piecewise continuous
//
...
std::string mesh_name, mesh_type, bc_id, plot_file;
