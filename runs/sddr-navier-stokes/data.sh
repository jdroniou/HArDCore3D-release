...
#	mesh[3]="RF:Prysmatic-Cells/RF_fmt/vprism_16x16x16"
	;;
    Cubic-Cells)
	mesh[1]="RF:Cubic-Cells/RF_fmt/gcube_48x48x48"
	mesh[2]="RF:Cubic-Cells/RF_fmt/gcube_64x64x64"
...
#	mesh[4]="RF:Voro-small-0/RF_fmt/voro-8"      # Newton struggles to converge, this mesh has a high (ir)regularity parameter
	mesh[4]="RF:Voro-small-0/RF_fmt/voro-10"
#	mesh[5]="RF:Voro-small-0/RF_fmt/voro-12"
