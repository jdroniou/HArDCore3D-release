...
#	mesh[4]="RF:Cubic-Cells/RF_fmt/gcube_16x16x16"
	...
	;;
    Cubic-Cells-coarse)
	mesh[1]="RF:Cubic-Cells/RF_fmt/gcube_16x16x16.coarse.6"
	mesh[2]="RF:Cubic-Cells/RF_fmt/gcube_16x16x16.coarse.5"
#	mesh[3]="RF:Cubic-Cells/RF_fmt/gcube_16x16x16.coarse.4"
#	mesh[4]="RF:Cubic-Cells/RF_fmt/gcube_16x16x16.coarse.3"
	;;
    Voro-Tets-2)
	...
	;;
    Voro-Tets-1-coarse)
  mesh[1]="Voro-Tets-1/RF_fmt/voro.1.coarse.2"
  mesh[2]="Voro-Tets-1/RF_fmt/voro.2.coarse.3"
  mesh[3]="Voro-Tets-1/RF_fmt/voro.3.coarse.2"
  mesh[1]="Voro-Tets-1/RF_fmt/voro.4.coarse.4"
	;;
    Voro-small-0)
